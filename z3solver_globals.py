...
def most_blacks(s: Solver, colored: list, puzzle: list, n: int) -> None:
    max_black = (n//2)+1
    for i in range(n):
...
def pair_isolation(s: Solver, colored: list, puzzle: list, n: int) -> None:
    if n < 4:
        return
...
def close_isolation(s: Solver, colored: list, puzzle: list, n: int) -> None:
    for i in range(n):
        for j in range(n-2):
...
def white_bridges(s: Solver, colored: list, puzzle: list, n: int) -> None:
    for i in range(n-1):
